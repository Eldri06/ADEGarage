...
A full-stack web application built with Laravel, featuring product browsing, cart management, order tracking, and a dedicated admin dashboard with Machine Learning features such as Linear Regression and Clustering.
