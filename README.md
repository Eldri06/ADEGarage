...
A full-stack web application built with Laravel 9, featuring product browsing, cart management, order tracking, and a dedicated admin dashboard with Machin Learning features such as XGBooost and Clustering.
